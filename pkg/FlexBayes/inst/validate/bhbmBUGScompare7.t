{cat("----- Compare bhbm, BUGS for the seeds data w/ interaction random effects ----------\n");T}
{
...
#  random effects.
	...
	seedsSampler <- bhbm.sampler( nSamples = 1000, nBurnin=10000,
	  nThin = 20, init.point="user's choice", 
	  params.init = list( random.var = rep(1, 4), fixed.coef = 0,
