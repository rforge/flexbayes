#ifndef BAYESIAN_POISSON_LOG_LINK_MODEL_H
#define BAYESIAN_POISSON_LOG_LINK_MODEL_H

#include "BayesianGlmModel.h"
#include "DistributionExtended.h"

class BayesianPoissonLogLinkModel: public BayesianGlmModel
{
  private:
    CVector ** exposures;
    CVector ** counts;
  ...
  public:
    ...
    virtual ~BayesianPoissonLogLinkModel();
    void emptyModel();
    ...
    void generateLambdas( CMatrix * simulated_mu );
    ...
    //required methods
    inline char * name() { return "Bayes Hierarchical Poisson-Gamma Conjugate Model"; }
...
}; //end BayesianPoissonLogLinkModel


#endif /* BAYESIAN_POISSON_LOG_LINK_MODEL_H */
