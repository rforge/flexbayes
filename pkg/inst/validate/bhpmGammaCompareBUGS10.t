{cat("--- Compare bhpm, BUGS gamma-conj model w/ random eff.s, specify inits 2 -----\n");T}
{
...
#  specify the initial values for multiple chains.
#
...
compareSampleDistributions(getSamples(bugs.samples), 
  getSamples(bhpm.samples[[1]]), print.ks=F, 
